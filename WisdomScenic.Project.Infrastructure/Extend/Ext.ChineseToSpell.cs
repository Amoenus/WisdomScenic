...
namespace WisdomScenic.Project.Infrastructure.Extend
{
    public static partial class Ext
    {
        ...
        /// <param name="strChinese"></param>
        /// <returns></returns>
        public static string ConvertToFirstSpell(this string strChinese)
        {
        ...
        /// <returns></returns>
        public static string GetFirstSpell(this string charChinese)
        {
        ...
        /// <param name="charChinese"></param>
        /// <returns></returns>
        public static string ConvertFirstSpell(this string charChinese)
        {
            Regex MyRegex = new Regex("^[一-龥]$");
            byte[] array = new byte[2];
            string returnstr = "";
